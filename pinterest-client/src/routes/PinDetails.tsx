...
import { TPin, TPinDetail, TUser } from "../types/types";
import { pinDetailMorePinQuery, pinDetailQuery } from "../utils/data";
import { client, urlFor } from "../utils/client";
import { fetchUser } from "../utils/fetchUser";
import { useOutSideClickShareMenu } from "../hooks/outSideClickShareMenu";
import { MasonryLayout, ShareMenu, User } from "../components";
...
export default function PinDetails() {
  ...
  const [pinDetail, setPinDetail] = useState<TPinDetail | null>(null);
